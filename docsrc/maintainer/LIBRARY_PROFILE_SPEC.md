...
- [`pytoyopuc-computerlink/docsrc/MODEL_RANGES.md`](https://github.com/fa-yoshinobu/pytoyopuc-computerlink/blob/main/docsrc/MODEL_RANGES.md)
- [`pytoyopuc-computerlink/docsrc/TESTING.md`](https://github.com/fa-yoshinobu/pytoyopuc-computerlink/blob/main/docsrc/TESTING.md)
...
Applications such as `Toyopuc.DeviceMonitor` must not maintain their own area
...
`Toyopuc.DeviceMonitor` uses these profile definitions for:
