...
public sealed class ExampleCliContractTests
{
    ...
    [Theory]
    [InlineData(
        @"examples\Toyopuc.MinimalRead\Toyopuc.MinimalRead.csproj",
        "Toyopuc minimal read example",
        "P1-D0000")]
    [InlineData(
        @"examples\Toyopuc.SmokeTest\Toyopuc.SmokeTest.csproj",
        "Toyopuc smoke test",
        "default: P1-D0000")]
    [InlineData(
        @"examples\Toyopuc.SoakMonitor\Toyopuc.SoakMonitor.csproj",
        "Toyopuc soak monitor",
        "P1-D0000,P1-M0000,U08000")]
    [InlineData(
        @"examples\Toyopuc.WriteLimitProbe\Toyopuc.WriteLimitProbe.csproj",
