...
- [**User Guide**](docs/user/USER_GUIDE.md): Connection setup and API reference.
- [**Troubleshooting**](docs/user/TROUBLESHOOTING.md): Common issues and FAQ.
- [**QA Reports**](docs/validation/reports/): Formal evidence of communication with real Toyopuc hardware.
- [**Architecture**](docs/maintainer/ARCHITECTURE.md): Design philosophy and background.
- [**Release Process**](docs/maintainer/RELEASE_PROCESS.md): Details on building and NuGet packaging.
